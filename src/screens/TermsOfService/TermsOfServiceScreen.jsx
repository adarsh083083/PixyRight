            ...
            <View style={{ backgroundColor: "white", width: "100%" }}>
              ...
              >
                ...
                <Text style={styles.tcP}>
                  ...
                  privacy policy govern [business name]’s relationship with you
                ...
                <Text style={styles.tcP}>
                  ...
                  company registration number is [company registration number
                  and place of registration]. The term ‘you’ refers to the user
                  or viewer of our website.
                </Text>
                <Text style={styles.tcL}>
                  {"\u2022"} The content of the pages of this website is for
                  your general information and use only. It is subject to change
                  without notice.
                </Text>
                <Text style={styles.tcL}>
